...
PURPIE_API_KEY=$(generatePassword 25)
PURPIE_API_SECRET=$(generatePassword 35)
...
sed -i "" \
    ...
    -e "s#PURPIE_API_KEY=.*#OCTOPUS_API_KEY=${OCTOPUS_API_KEY}#g" \
    -e "s#PURPIE_API_SECRET=.*#OCTOPUS_API_SECRET=${OCTOPUS_API_SECRET}#g" \
    "$(dirname "$0")/.env"
